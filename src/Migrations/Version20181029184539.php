 ...
 */
final class Version20181029184539 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE answer (id INT NOT NULL, question_id INT DEFAULT NULL, answer_text VARCHAR(255) NOT NULL, answer_upvotes INT DEFAULT NULL, answer_downvotes INT DEFAULT NULL, answer_author VARCHAR(255) NOT NULL, answer_date TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_DADD4A251E27F6BF ON answer (question_id)');
        $this->addSql('CREATE TABLE category (id INT NOT NULL, category_name VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE question (id INT NOT NULL, category_id INT DEFAULT NULL, question_text VARCHAR(255) NOT NULL, question_upvotes INT DEFAULT NULL, question_downvotes INT DEFAULT NULL, question_author VARCHAR(255) NOT NULL, question_date TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
