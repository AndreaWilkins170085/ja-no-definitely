 ...
 */
final class Version20181022060646 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE question (id INT NOT NULL, question_id INT NOT NULL, category VARCHAR(255) NOT NULL, question_text VARCHAR(255) NOT NULL, asked_by VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
